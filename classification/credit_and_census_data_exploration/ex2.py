...
# Credit:
caminho_novo_credit = 'credit_and_census_data_base\credit_data.csv'
...
# Censo:
caminho_novo_censo = 'credit_and_census_data_base\census.csv'
...
# Salvando as bases de dados de treinamento e teste após o pre-processamento para que seja possível importá-los em outros arquivos

novo_credit = 'credit_and_census_data_base\credit.pkl'
novo_censo = 'credit_and_census_data_base\censo.pkl'

caminho_credit = os.path.join(caminho_arquivo, novo_credit)
caminho_censo = os.path.join(caminho_arquivo, novo_censo)

import pickle

with open(caminho_credit, mode = 'wb') as f:
    pickle.dump([X_credit_treinamento, X_credit_teste, Y_credit_treinamento, Y_credit_teste], f)

with open(caminho_censo, mode = 'wb') as f:
