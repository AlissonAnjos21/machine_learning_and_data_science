...
x_health_insurance = x_standard_scaler.fit_transform(x_health_insurance)
y_standard_scaler = StandardScaler()
y_health_insurance = y_standard_scaler.fit_transform(y_health_insurance.reshape(-1, 1))
...
rbf_graph = px.scatter(x = x_health_insurance.ravel(), y = y_health_insurance.ravel())
